...
public class ListOfELaments {
    ...
    public void test1 () {
        ...
        public void test2 () {
            ...
            //regular findElement method will throw NSE if locator doesnot exist
            //WebElement buttons = driver.findElement(By.tagName("buttonjfjhgjhg"));
            ...
            List<WebElement> buttons = driver.findElements(By.tagName("buttonjfjhgjhg"));
